    ...
    <div className="min-h-screen  bg-slate-50">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        <div className="transform hover:scale-[1.01] transition-transform duration-300">
          <div className="bg-white rounded-2xl shadow-md overflow-hidden border-t-4 border-amber-800">
              ...
              <div className="grid gap-3">
                {Array.isArray(morningList) &&
                  morningList.map((pooja, idx) => (
                    <div
                      key={idx}
                      className="flex justify-between items-center py-2 px-3 rounded-md hover:bg-orange-50 transition-colors border-l-4 border-amber-800"
                    >
