    ...
    <footer className="bg-gray-900 text-gray-300 py-10 w-full border-t border-gray-800">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[max-content_1fr_1fr] gap-y-8 md:gap-x-16 items-start">
          ...
          <div className="flex flex-row items-center justify-center md:justify-start gap-3 min-w-0">
            <FaPrayingHands className="text-amber-400 text-3xl md:text-4xl shrink-0" />
            <h2 className="font-bold text-white uppercase tracking-wider whitespace-nowrap text-[15px] sm:text-lg md:text-xl lg:text-2xl">
              {t("temple_full_name")}
            </h2>
          </div>
          ...
          <div className="flex flex-col items-center md:items-start w-full">
            <div className="w-fit">
              <h3 className="text-md font-semibold text-amber-400 mb-4 border-b border-amber-400/20 pb-2 text-center md:text-left uppercase tracking-wider whitespace-nowrap">
                {t("contact_info")}
              </h3>
              ...
              <div className="bg-gray-800/40 p-5 rounded-xl border border-gray-700/50">
                <div className="space-y-4">
                  <div className="flex items-center justify-between text-xs sm:text-sm gap-4">
                    ...
                    <span className="font-mono text-white bg-gray-700 px-2 py-1 rounded whitespace-nowrap">6:00-8:30 AM</span>
                  </div>
                  <div className="flex items-center justify-between text-xs sm:text-sm border-t border-gray-700/50 pt-4 gap-4">
                    ...
                    <span className="font-mono text-white bg-gray-700 px-2 py-1 rounded whitespace-nowrap">5:00-7:00 PM</span>
                  </div>
                </div>
              </div>
            </div>
