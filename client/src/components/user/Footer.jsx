        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="flex items-center gap-3">
              <FaPrayingHands className="text-amber-400 text-3xl shrink-0" />
          ...
          <div className="flex flex-col items-center md:items-start w-full">
            <h3 className="text-lg font-semibold text-amber-400 mb-6 border-b border-amber-400/30 pb-2 w-full text-center md:text-left">
              {t("contact_info")}
            </h3>
            <ul className="space-y-4 text-sm w-full">
              ...
              <li className="flex items-start justify-center md:justify-start gap-3">
                ...
                <span className="max-w-[250px] text-center md:text-left">
                  {t("temple_location")}
                </span>
              </li>
            </ul>
            ...
            <div className="bg-gray-800/50 p-5 rounded-xl border border-gray-700 w-full max-w-[300px]">
              <div className="space-y-4">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="bg-gray-700 px-3 py-1 rounded text-white font-mono">
                    6:00-8:30 AM
                  </span>
                </div>
